class PlayerScene extends eui.Component implements  eui.UIComponent {
	...
	public btn_rtn:eui.Button;
	public btn_zb:eui.Button;
	public btn_qh:eui.Button;
	public scr_zb:eui.Scroller;
	public list_zb:eui.List;
	...
	protected childrenCreated():void
	{
		...
		// 把eui数组作为list的数据源
		this.list_zb.dataProvider = euiArr;
		// 隐藏进度条
		this.scr_zb.horizontalScrollBar.autoVisibility = false;
		// 给返回按钮添加事件
		this.btn_rtn.addEventListener(egret.TouchEvent.TOUCH_TAP, this.returnMain, this);
	}
